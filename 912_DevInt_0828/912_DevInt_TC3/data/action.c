Action()
{
	...
	web_submit_data("getconfigs.do", 
		...
		"Name=requestToken", "Value=19334b5b28bd3", ENDITEM, 
		"Name=requestLanguageToken", "Value=194350dd678f", ENDITEM, 
	...
	lr_end_transaction("TC3_4_Click_Addresses",LR_AUTO);
	...
	lr_end_transaction("TC3_5_Search_Addresses",LR_AUTO);
	...
	lr_end_transaction("TC3_9_Click_Parcel",LR_AUTO);
	...
	lr_end_transaction("TC3_10_Search_Parcel",LR_AUTO);
	...
	lr_end_transaction("TC3_14_Click_Owner",LR_AUTO);
	...
	web_submit_data("refOwnerList.do_2", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFOWNERLIST", "Value=84d33eb2d6270c743d7856e31b2cfbe9", ENDITEM, 
	...
	lr_end_transaction("TC3_15_Search_Owner",LR_AUTO);
	...
	web_custom_request("refProfessionalDetail.do", 
		...
		"Snapshot=t594.inf", 
		"Mode=HTTP", 
		"Body=TRANSACTION_TOKEN_KEY_FOR_REFPROFESSIONALLISTACTIONFORM=cf59cdc3ca46bd9c1f7cc5f41551c6ad&value(FirstEntryURL)=%2Fportlets%2Fprofessional%2Fref%2FrefProfessionalList.do%3Fmode%3DquickQuery%26lookup%3Dfalse&value(CurrentEntryURL)=%2Fportlets%2Fprofessional%2Fref%2FrefProfessionalList.do%3Fmode%3DquickQuery%26lookup%3Dfalse&portlet_language=en_US&refresh_target=&refresh_url=&buttonName=&modeName=quickQuery&module=Building&accelasubmitbuttonname=&itemName=&CurrentViewID=20041&exceptionLogID=&"
		"generalCAPSearch=&value(selectedQuickQuery)=&objectName=licenseList&CheckBoxName=&MaxNumber=&ExportFileType=print&CurrentViewID=20041&sessionIdFromWindow=OI%2Bx0hdJ0Pv1Z%2BKh5Fl1bVvX&listID=&printType=&checkBoxValue=&disableEduSectionFlag=&isContactValidateBtnFlag=&value(mode)=searchresult&isDynaPaging=true&page-navigator-input-id=1&stateLicense_859648=0312&stateLicense_200859976=060606&stateLicense_2200860521=09-ARCH-00003&stateLicense_2200860532=09-ARCH-00005&stateLicense_2200860535="
		"09-ARCH-00007&stateLicense_2200860536=09-ARCH-00008&stateLicense_2200860570=09-ARCH-00010&stateLicense_2200860519=09-PEOP-00001&stateLicense_2200860520=09-PEOP-00002&stateLicense_20001437756=101001010100&pageSizeR=10&", 
		LAST);
	...
	lr_end_transaction("TC3_19_Click_LicenseProfessionals",LR_AUTO);
	...
	lr_end_transaction("TC3_19_Click_LicenseProfessionals_SearchTab",LR_AUTO);
	...
	web_submit_data("refProfessionalList.do_3", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFPROFESSIONALLISTACTIONFORM", "Value=cf59cdc3ca46bd9c1f7cc5f41551c6ad", ENDITEM, 
	...
	lr_end_transaction("TC3_20_Search_LicenseProfessionals_Submit",LR_AUTO);
	...
	lr_end_transaction("TC3_24_Click_Contacts",LR_AUTO);
	...
	lr_end_transaction("TC3_25_Click_Search_Contacts_Tab",LR_AUTO);
	...
	lr_end_transaction("TC3_25_Search_Contacts_Submit",LR_AUTO);
	...
	web_submit_data("getconfigs.do_2", 
		...
		"Name=cookieUserName", "Value=", ENDITEM, 
		"Name=cookieAgencyName", "Value=", ENDITEM, 
		"Name=requestToken", "Value=1950274523091", ENDITEM, 
		"Name=requestLanguageToken", "Value=196338a739794", ENDITEM, 
		"Name=password1", "Value=", ENDITEM, 
		"Name=servProvCode", "Value=", ENDITEM, 
		"Name=username", "Value=", ENDITEM, 
		"Name=password", "Value=", ENDITEM, 
